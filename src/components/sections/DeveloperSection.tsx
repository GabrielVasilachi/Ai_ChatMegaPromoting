...
export default function DeveloperSection() {
  ...
  // Anchor to position the mobile iPhone container just under the button
  ...
  // Vibrație pentru container inputuri
  ...
  // Compute top position for the mobile iPhone container from the anchor below the CTA
  useEffect(() => {
    const computeTop = () => {
      ...
      // Place phone slightly below the anchor (which sits just under the CTA button)
  ...
  return (
  <section ref={ref} className="min-h-[150vh] md:min-h-screen bg-black py-0 md:py-20 flex items-center justify-center overflow-hidden relative">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Content */}
          <div className="space-y-8 -mt-[30rem] md:mt-0">
            ...
            {/* Mobile anchor for positioning the iPhone container exactly under the CTA */}
            <div ref={mobilePhoneAnchorRef} className="md:hidden h-0" />
              {/* Mobile phone preview under CTA (positioned via computed top, doesn't affect section height) */}
              <div className="md:hidden absolute left-1/2 transform -translate-x-1/2 flex flex-col items-center justify-center" style={{ width: '120vw', marginLeft: 'auto', top: mobilePhoneTop !== null ? `${mobilePhoneTop}px` : 'calc(100% + 700px)' }}>
                <img
                ...
                {/* Black overlay: animate in from above, then fade out */}
                <div
                  style={{
                    position: 'absolute',
                    left: '50%',
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: 'center', marginBottom: '10px' }}>
            <div style={{ color: '#1C1C1E', fontWeight: 600, fontSize: '18px', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", "Helvetica Neue", Helvetica, Arial, sans-serif' }}>
              Conectare Demo AI
            </div>
            <div style={{ color: '#8E8E93', fontSize: '12px', marginTop: '4px' }}>Completează datele pentru test</div>
          </div>

...
export default function ROICalculator() {
  ...
  return (
    <section ref={ref as any} className="px-6 sm:px-8 lg:px-12 py-20 sm:py-24 bg-gray-300 relative">
...
// Note: This component is designed to be used in a Next.js application with Tailwind CSS and Framer Motion for animations.
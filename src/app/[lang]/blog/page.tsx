        ...
        {imageSrc ? (
          title === "Parteneri cu UpNext Accelerator: $10K Start Funding" ? (
            <div className="aspect-[16/9] w-full flex items-center justify-center">
              <img src={imageSrc} alt={title} className="max-h-32 w-auto object-contain" style={{borderRadius: 0, border: 'none', margin: 0, padding: 0, display: 'block'}} />
            </div>
          ) : (
            <div className="aspect-[16/9] w-full">
              <img src={imageSrc} alt={title} className="w-full h-full object-cover rounded-lg border border-gray-200" />
            </div>
          )
        ) : (
